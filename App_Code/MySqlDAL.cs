...
public class MySqlDAL
{
    ...
    public MySqlDAL()
    {
        ...
        _ConnectionString = ConfigurationManager.ConnectionStrings["GeneDB"].ConnectionString;
    }
    ...
    /// 数据库命令
    /// </summary>
    private MySqlCommand CreateMySqlCommand()
    {
    ...
    #region 执行 MySqlCommand 的ExecuteNonQuery、ExecuteReader、ExecuteScalar、ExecuteXmlReader方法
    ...
    /// <returns></returns>
    public int ExecuteNonQuery(string sql, MySqlParameter[] parameters, CommandType cmdType, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
    ...
    /// <param name="parameters">参数</param>
    /// <param name="cmdType">命令类型</param>
    public int ExecuteNonQuery(string sql, MySqlParameter[] parameters, CommandType cmdType)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public MySqlDataReader ExecuteReader(string sql, MySqlParameter[] parameters, CommandType cmdType, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
            ...
            if (IsUseTransaction)
            {
                ...
                try
                {
                    MySqlDataReader sdr = _SqlCommand.ExecuteReader();
                    _SqlCommand.Transaction.Commit();
                    return sdr;
                }
                catch (Exception ex)
    ...
    /// </summary>
    /// <param name="sql">SQL语句</param>
    /// <param name="parameters">参数。类型为Dictionary字典（参数名带不带@都可以）或 MySqlParameter[] </param>
    /// <param name="cmdType">命令类型</param>
    /// <returns></returns>
    public MySqlDataReader ExecuteReader(string sql, MySqlParameter[] parameters, CommandType cmdType)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public object ExecuteScalar(string sql, MySqlParameter[] parameters, CommandType cmdType, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
    ...
    /// <param name="cmdType">命令类型</param>
    /// <returns></returns>
    public object ExecuteScalar(string sql, MySqlParameter[] parameters, CommandType cmdType)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public DataTable ExecuteDataTable(string sql, MySqlParameter[] parameters, CommandType cmdType, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
            ...
            {
                MySqlDataAdapter sda = new MySqlDataAdapter(_SqlCommand);

                if (IsUseTransaction)
                {
                    MySqlTransaction tran = _SqlCommand.Connection.BeginTransaction();
    ...
    /// <param name="parameters">参数</param>
    /// <param name="cmdType">执行类型</param>
    public DataTable ExecuteDataTable(string sql, MySqlParameter[] parameters, CommandType cmdType)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public DataSet ExecuteDataSet(string sql, MySqlParameter[] parameters, CommandType cmdType, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
    ...
    /// <param name="cmdType">执行类型</param>
    /// <returns></returns>
    public DataSet ExecuteDataSet(string sql, MySqlParameter[] parameters, CommandType cmdType)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public PagingData ExecutePaging(int PageSize, int pageNumber, string OrderBy, string sql, MySqlParameter[] parameters, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
    ...
    /// <param name="parameters">参数（可空）</param>
    /// <returns></returns>
    public PagingData ExecutePaging(int PageSize, int pageNumber, string OrderBy, string sql, MySqlParameter[] parameters = null)
    {
    ...
    /// <param name="IsUseTransaction">是否使用事务</param>
    /// <returns></returns>
    public PagingData ExecutePageByDataTable(int PageSize, int pageNumber, string sql, MySqlParameter[] parameters, bool IsUseTransaction)
    {
        MySqlCommand _SqlCommand = CreateMySqlCommand();
        try
        {
    ...
    /// <param name="parameters">参数（可空）</param>
    /// <returns></returns>
    public PagingData ExecutePageByDataTable(int PageSize, int pageNumber, string sql, MySqlParameter[] parameters = null)
    {
    ...
    public bool Exists(string TableName, string PrimaryKey, object PrimaryKeyValue)
    {
        try
        {
            ...
            DataTable dt = ExecuteDataTable(sql, new MySqlParameter[] {
                    new MySqlParameter("@"+PrimaryKey,PrimaryKeyValue)
                }, CommandType.Text);
        ...
        {
            throw new Exception("MySqlDAL类中的Exists方法错误。" + exp.Message);
        }
    }
    ...
    /// <returns></returns>
    public MySqlParameter CreateMySqlParameter(string parameterName, object value)
    {
